...
%    e.g. "An IDN" or "A identification number (IDN)"
%  * \Glstitle: writes out the title in full
%    e.g. "Pulsar Wind Nebula"
%  * \Glspltitle: writes out the plural title in full
...
\newcommand{\Glstitle}[1]{\glsentryuserii{#1}}
\newcommand{\Glspltitle}[1]{\glsentryuseriiii{#1}}
