...
In \iac{CGS}, it has units of \fluxdensityunits.
...
In \iac{CGS}, \dnde is in units of \prefunits.
...
It is traditionally normalized as though it was a probability:
  ...
  \end{equation}
Therefore, in \iac{CGS} \pdf has units of \pdfunits
...
this kind of sourcc. \todo[inline]{FINISH DISCUSSION}
...
\todo[inline]{Discuss how diffuse background is more complciated and requires
a mapcube.}
