...
\explorerxi operated in the energy
...
\todo[inline]{CENTER ALL FIGURES IN PAPER with \\centering command}
...
\todo[inline]{How many gamma-ray did EGRET Detect}
\todo[inline]{Get a picture of EGRET to include}
\todo[inline]{Get EGRET sky map picture to include}
