...
Concurently with the major adavnces in space-based $\gamma$-ray detects
came improved balloon-based $\gamma$-ray detectors.

\todo[inline]{Discuss
\cite{kniffen_1970_study-gamma} and \cite{browning_1971_detection-pulsed}.
Do a literature seach to see if there are other balloon experiments
which detected similar stuff.
}
...
9, 1975.  Similar to \ac{SAS-2}, \cosb included a spark chamber
for reading out the $\gamma$-ray events and had a peak effective
area of $\sim 50\unitspace\cm^2$ at $\sim400\unitspace\mev$
\citep{bignami_1975_cos-b-experiment}.  It improved upon the design
