...
\gls{IC} upscattering.  Following the discovery of the neutral
...
of several sources of $\gamma$-rays including solar flares, \glspl{PWN},
and active galaxies.
...
\cite{kraushaar_1965_explorer-experiment}.  It was developed at \gls{MIT}
...
\Gls{OSO-3}, also developed by Kraushaar, followed \explorerxi
as the next major astrophysical $\gamma$-ray detector
\cite{kraushaar_1972_high-energy-cosmic}.  \Gls{OSO-3} 
...
detected by \gls{OSO-3}. This figure is from 
\cite{kraushaar_1972_high-energy-cosmic}. }
\end{figure}



The major discovery by \gls{OSO-3} was confirmed by a ballon-based
...
\gls{SAS-2} was a dedicated $\gamma$-ray detector
launched by \gls{NASA} in November 15, 1972.  \Gls{SAS-2} was
\cite{fichtel_1975_high-energy-gamma-ray} It improved upon \gls{OSO-3}
...
of the incident $\gamma$-ray. \Gls{SAS-2} had a PSF $\sim5\degree$ at 30
\mev and $\sim1\degree$ at 1 \gev.

\Gls{SAS-2} collected data for over 6 months before a power supply
failure ended data collection. \Gls{SAS-2} Observed over 8,000
$\gamma$-ray photons covering $\sim55\%$ of
the sky including most of the Galactic plane.  
\Gls{SAS-2} disovered strong emission
...
\citep{thompson_1977_sas-2-high-energy}.  In addition, \gls{SAS-2}
...
was eventually discovered to be a pulsar by \gls{EGRET}
\citep{bertsch_1992_pulsed-high-energy} and retroactivly by \gls{SAS-2}
...
on August 9, 1975, \gls{ESA} launched \cosb, a $\gamma$-ray 
detector similar to \gls{SAS-2}. 
\cosb included a spark chamber but
improved upon the design of
\gls{SAS-2} by including a calorimiter below the spark chamber
which improved the energy resolution to $<100\%$ for energies $\sim
3\unitspace\gev$ \citep{bignami_1975_cos-b-experiment}.
\cosb has a comparable effective area to \gls{SAS-2}:
...
\todo[inline]{How many $\gamma$-rays \gls{EGRET} detect?}
\todo[inline]{How many pulsars did \gls{EGRET} detect?}
