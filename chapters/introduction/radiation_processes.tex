...
Here, $\velocity_\electron$ is the velcoity of a the
...
The actual evaluation of these cross sections is quite
involved.  The electron-electron cross section was worked out in
\cite{haug_1975a_bremsstrahlung-production}.  The electron-ion cross
section XXXXX.
...
\todo[inline]{Cite the Kamae crosssection paper for detailed calcuations.}
