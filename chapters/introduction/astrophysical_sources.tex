...
Radio emission from the Crab nebula was first detected in
1949 \citep{bolton_1949a_positions-three}.  The synchrotron
hypothesis for the observed emission was first proposed by
\cite{shklovskii_1957a_nature-optical}.  \todo[inline]{Make note about
polarized emission} X-rays from the object were first detected in
\cite{bowyer_1964a_lunar-occultation}.  As was discus As was discussed in
\secref{history_gamma_ray_detectors}, the Crab pulsar was first detected
in \cite{browning_1971_detection-pulsed}.

As was discussed in \secref{astrophysical_sources}, the Crab pulsar
...
includes 31 \ac{VHE} sources classified as \ac{PWNe}.
