...
such as \hessj{1825} \citep{aharonian_2006a_h.e.s.s.-survey} and in can
...
($\breakingindex=3$) and used \eqnref{energy_dot_vs_time}.

On the other hand, the number of \ac{IC}-emitting particles $n_\text{IC}$
...
relations with \ac{LAT} observations in \chapref{population_study}
