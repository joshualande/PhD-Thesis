...
\tablecomments{For the \ac{VHE} \ac{PWN} candidates, their multiwavelenth properties.
This table includes the X-ray flux in the $1\unitspace\tev$ to $30\unitspace\tev$ energy range,
the 
[INSERT MANUALLY]}
