...
$\gamma$-ray emitting \acp{PWN}.  In \chapref{extended_analysis}, we
developed a new method to study spatially-extended sources.  In
\chapref{extended_search}, we searched for extended \ac{2FGL} sources.
...
sources coincident with \acp{PWN} candidates (\hessj{1616}, \hessj{1632},
\hessj{1837}).
...
\hessj{1023}. Although this source is classified as a massive star cluster
...
following Wilks' Theorem (see \subsecref{monte_carlo_validation}),
...
\secref{systematic_errors_on_extension}.  The second is due
