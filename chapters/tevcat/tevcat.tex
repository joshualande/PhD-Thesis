...
Four of these sources are first reported in this work:
...
(\psrj{1119}, \psrj{1301}, \psrj{1420}, \psrj{1838}),
and they all have a hard spectrum which connects to the
spectra observed at \ac{VHE} energies.

We caution that two of these sources have an associated
LAT-detected pulsar and were therefore studied in \chapref{offpeak}.

We mention that \psrj{1119}, \psrj{1420}, and \psrj{1838}
are all detected by the LAT and therefore were studied in
\secref{offpeak}.
In \Secref{offpeak}, \psrj{1119} has $\ts=61.3$ and is classified as a ``U''-type
source because the spectrum is relativly soft (spectral index$\sim2.2$).
But in the off-peak analysis, one can observe a faint hard component of
the emission at high energy as well as a stronger component at low energy.
In the off-peak analysis, we calculated $\ts=13.8$ in the energy range from 10 \gev
to 316 \gev when computing an SED with a fixed spectral index of 2.
So the off-peak analysis is fairly consistent with this work.

For \psrj{1420}, \ldots
\url{http://www.slac.stanford.edu/~lande/pwnpipeline/v37/website/PSRJ1420-6048.html}

The off-peak analysis of \psrj{1838} detects
a soft and significantly-cutoff spectrum which is
\url{http://www.slac.stanford.edu/~lande/pwnpipeline/v37/website/PSRJ1838-0537.html}
In the residual test-statistic map, there is significant emission
towards the position of \hess{J1841}.  The off-peak emission is
sigificantly-extended.  Tehrefore our analysis are most-likely compatable.
...
\hess{J1023} \citep{ackermann_2011a_fermi-lat-search},
...
Finally, note that we have add \hess{J1848} to the list of
