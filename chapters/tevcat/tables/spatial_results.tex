...
\tablabel{tevcat_spatial_spectral}}
...
\tablecomments{The \ac{VHE} \acp{PWN} candidates significantly detected by
the \ac{LAT}.  Column 2 is our classfication of the \ac{LAT} emission.
Column 3 is \tstev, Column 4 is the observed flux, and Column 5 is
the spectral index. The two errors on the flux and spectral index are
