...
\tablecomments{The \ac{VHE} sources that we at \gev energies.
The classifications come from \tevcat and are \acs{PWN} for
\acl{PWN}, \ac{UNID} for \acl{UNID}, and \acs{MSC} for \acl{MSC}.
